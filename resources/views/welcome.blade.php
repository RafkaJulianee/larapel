...
<head>
    ...
    <title>Sekolah Unggullll - Membangun Generasi Emas</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex">
                    <a href="{{ route('login') }}" class="px-6 py-2.5 bg-orange-600 hover:bg-orange-700 text-white text-sm font-semibold rounded-full transition-all duration-300 shadow-lg shadow-orange-500/30 hover:shadow-orange-500/50 transform hover:-translate-y-0.5">
                        Daftar Sekarang
                    </a>
                </div>
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-white border-t border-gray-100 absolute w-full left-0 top-20 shadow-lg">
            <div class="px-4 pt-4 pb-6 space-y-2">
                ...
                <div class="pt-4 mt-4 border-t border-gray-100">
                    <a href="{{ route('login') }}" class="block w-full text-center px-6 py-3 bg-orange-600 text-white font-semibold rounded-xl shadow-lg shadow-orange-500/30 hover:bg-orange-700 transition-colors">
                        Daftar Sekarang
                    </a>
                </div>
            </div>
